...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(lengthInRangePredicate.test("Hello w"));//true
        ...
        System.out.println(abs.applyAsInt(4));//4
        System.out.println(abs.applyAsInt(0));//0
        ...
        System.out.println(identityFunction.applyAsInt(12));//12
        System.out.println(squareFunction.applyAsInt(3));//9
        System.out.println(squareFunction.applyAsInt(4));//16
